...
VALUES		('YFS_SONG_ATLAS', 						256, 		'yfsSongIcons256.dds',				8,				2),
			...
			('YFS_UNIT_FLAG_ATLAS',					32,			'yfsUnitFlagAlpha32.dds',			4, 				2);
--==========================================================================================================================
-- UnitArtDefines
--==========================================================================================================================
------------------------------------------------------------------------------------------------------------------------
...
INSERT INTO ArtDefine_UnitInfoMemberInfos 	
		...
		('ART_DEF_UNIT_BEIWEI_CAVALRY', 				'ART_DEF_UNIT_MEMBER_BEIWEI_CAVALRY1',		 3),
...
INSERT INTO ArtDefine_UnitInfoMemberInfos 	
		(UnitInfoType,								UnitMemberInfoType,								 NumMembers)
SELECT	'ART_DEF_UNIT_BEIWEI_FOOT', 				'ART_DEF_UNIT_MEMBER_BEIWEI_FOOT',				 12
FROM ArtDefine_UnitInfoMemberInfos WHERE UnitInfoType = 'ART_DEF_UNIT_NATIONAL_GUARD';
...
INSERT INTO ArtDefine_UnitInfos 
		(Type, 										DamageStates,	Formation)
SELECT	'ART_DEF_UNIT_SP_FEIHUCHUAN',				DamageStates, 	Formation
FROM ArtDefine_UnitInfos WHERE Type = 'ART_DEF_UNIT_TRIREME';

INSERT INTO ArtDefine_UnitInfoMemberInfos 	
		(UnitInfoType,								UnitMemberInfoType,								 NumMembers)
SELECT	'ART_DEF_UNIT_SP_FEIHUCHUAN', 				'ART_DEF_UNIT_MEMBER_SP_FEIHUCHUAN',			 NumMembers
