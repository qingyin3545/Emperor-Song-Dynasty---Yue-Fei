...
SELECT		('CIVILIZATION_YFS_SONG'), 	('CIVILIZATION_CHINA'),	('TXT_KEY_CIV_YFS_SONG_DESC'), 	('TXT_KEY_CIV_YFS_SONG_SHORT_DESC'), ('TXT_KEY_CIV_YFS_SONG_ADJECTIVE'), 	('TXT_KEY_CIV5_YFS_SONG_TEXT_1'),	('TXT_KEY_CIV5_YFS_SONG'), 	('PLAYERCOLOR_YFS_SONG'), ArtDefineTag, ArtStyleType, ArtStyleSuffix, ArtStylePrefix, ('YFS_SONG_ATLAS'),  ('YFS_SONG_ALPHA_ATLAS'),  0, 			('CHINA'),	 	('tcmSongMap.dds'), 	('TXT_KEY_CIV5_DOM_YFS_SONG_TEXT'), ('yfsSongDOM.dds')
...
VALUES		('CIVILIZATION_YFS_SONG',	'UILDINGCLASS_CASTLE',					'BUILDING_XIANGFAN'),		-- UB
			('CIVILIZATION_YFS_SONG',	'UILDINGCLASS_SONG_DIAOYUCHENG',		'BUILDING_DIAOYUCHENG');	-- UW
--==========================================================================================================================
...
VALUES		('CIVILIZATION_YFS_SONG', 	'UNITCLASS_U_GALLEASS',		'UNIT_U_PWS'),
			...
			('CIVILIZATION_YFS_SONG', 	'UNITCLASS_KNIGHT',			'UNIT_BEIWEI_CAVALRY'),
...
VALUES		('LEADER_YFS_YUEFEI', 		'TXT_KEY_LEADER_YFS_YUEFEI', 		'TXT_KEY_LEADER_YFS_YUEFEI_PEDIA_TEXT',  'TXT_KEY_LEADER_YFS_YUEFEI_PEDIA',	'yfsYueFeiScene.xmll',	11, 					8, 						10, 						9, 			5, 				4, 				2, 						6, 				6, 			4, 			4, 				1, 			1, 			'YFS_SONG_ATLAS', 	10);
--==========================================================================================================================	
...
--==========================================================================================================================	
INSERT INTO Traits 
			(Type, 						Description, 						ShortDescription,							EmbarkedToLandFlatCost,		ExtraFoundedCityTerritoryClaimRange,	FreeBuilding)
VALUES		('TRAIT_YFS_YUEFEI_SONG', 	'TXT_KEY_TRAIT_YFS_YUEFEI_SONG', 	'TXT_KEY_TRAIT_YFS_YUEFEI_SONG_SHORT',		1,							6,										'BUILDING_YFS_SONG');
--==========================================================================================================================	
...
INSERT INTO Buildings 	
			(Type, 								 BuildingClass, 			Cost,	Description,					MinAreaSize,	HurryCostModifier,	NeverCapture,	NukeImmune,		PortraitIndex,	IconAtlas)
VALUES		('BUILDING_YFS_SONG',				'BUILDINGCLASS_YFS_SONG', 	-1,		'TXT_KEY_CIV_YFS_SONG_DESC',	-1,				-1,					1,				1				0,				'YFS_SONG_ATLAS'),
--==========================================================================================================================
-- AUDIO
--==========================================================================================================================	
-- Audio_Sounds
...
VALUES		('AS2D_LEADER_MUSIC_YFS_YUEFEI_PEACE', 			'SND_LEADER_MUSIC_YFS_YUEFEI_PEACE', 	'GAME_MUSIC', 	80, 		80, 		1, 			0),
			('AS2D_LEADER_MUSIC_YFS_YUEFEI_WAR', 			'SND_LEADER_MUSIC_YFS_YUEFEI_WAR', 		'GAME_MUSIC', 	80, 		80, 		1,			0);
--==========================================================================================================================	
-- Diplomacy_Responses
--==========================================================================================================================	
INSERT INTO Diplomacy_Responses (LeaderType, ResponseType, Response, Bias) VALUES ('LEADER_YFS_YUEFEI','RESPONSE_FIRST_GREETING','TXT_KEY_LEADER_YFS_YUEFEI_FIRSTGREETING%','1');
INSERT INTO Diplomacy_Responses (LeaderType, ResponseType, Response, Bias) VALUES ('LEADER_YFS_YUEFEI','RESPONSE_DEFEATED',	'TXT_KEY_LEADER_YFS_YUEFEI_DEFEATED%','1');
INSERT INTO Diplomacy_Responses (LeaderType, ResponseType, Response, Bias) VALUES ('LEADER_YFS_YUEFEI','RESPONSE_DECLAREWAR', 'TXT_KEY_LEADER_YFS_YUEFEI_DECLAREWAR%','1');
--==========================================================================================================================	